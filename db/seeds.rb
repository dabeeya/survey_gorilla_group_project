...
david.surveys << Survey.create(title: "DBC Survey")
...
["Newts", "Newts", "Newts" "Other...Just kidding. Newts"].each do |cohort|
...
david.surveys << Survey.create(title: "Gangsta Survey")
...
christian.surveys << Survey.create(title: "Sports")
